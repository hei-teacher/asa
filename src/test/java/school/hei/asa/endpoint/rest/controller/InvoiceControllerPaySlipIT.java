...
// Verifie que /invoice/generate sauve reellement le payslip quand le worker est fullTimeEmployee,
// avec le vrai pipeline (resolveTemplateName -> apply -> generatePaySlip -> save), pas des mocks.
// BucketComponent/EventProducer restent mockes (FacadeITMockedThirdParties) : un vrai upload S3
// planterait ici, il n'y a pas de bucket reel dans cet environnement de test.
