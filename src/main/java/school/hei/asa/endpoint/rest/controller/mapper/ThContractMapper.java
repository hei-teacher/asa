  ...
  public List<ThContract> toTh(List<Contract> contracts) {
    ...
    contracts.forEach(
        current -> {
          ...
          // locale fixee explicitement : ce texte est reparse plus tard (ThContractService,
          // ici meme via startDate/localEndDate) - sans locale fixe, format et parse peuvent
          // utiliser des locales JVM par defaut differentes selon l'environnement et planter.
          var dateFormater = DateTimeFormatter.ofPattern("dd MMM yyyy", Locale.FRANCE);
