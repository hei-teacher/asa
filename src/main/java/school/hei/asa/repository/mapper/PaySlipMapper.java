...
public class PaySlipMapper {
  ...
  public JPaySlip toEntity(PaySlipForm paySlipForm, Worker worker) {
    ...
    // id deterministe (worker_code + year_month, deja uniques ensemble via V101_20) : pas besoin
    // d'aller chercher en base s'il faut generer un nouvel id ou reutiliser l'ancien, le merge()
    // de Spring Data fait deja cette verification lui-meme a la sauvegarde.
