...
public class WorkerLevelHistoryMapper {
  ...
  public List<WorkerLevelHistory> toDomain(List<JWorkerLevelHistory> jwlhList) {
    return jwlhList.stream().map(jWorkerLevelHistory -> toDomain(jWorkerLevelHistory, new Cache())).toList();
  }

  /*package-private*/ WorkerLevelHistory toDomain(JWorkerLevelHistory jWorkerLevelHistory, Cache cache) {
