...
class ContractToCasTest {

  static final LocalDate JAN1_2026 = LocalDate.of(2026, JANUARY, 1);
  ...
  static Contract studentContract(LocalDate entranceDate, int nbDays, int dailyPay) {
    return new Contract(
        mock(Worker.class),
        "jobTitle",
